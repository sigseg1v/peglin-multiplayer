...
public class MultiplayerUI : MonoBehaviour
{
    ...
    private void CreateMultiplayerPanel()
    {
        ...
        // Title bar
        var title = CreateText(_multiplayerPanel.transform, "MultiplayerTitle", "Spectating — Event Feed", 32);
        var titleRect = title.rectTransform;
        ...
        _multiplayerFeedText = CreateText(_multiplayerPanel.transform, "FeedText", "", 18);
